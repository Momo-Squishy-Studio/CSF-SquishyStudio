                ...
                <div class="col-12">
                    <div class="card card1">                        
						...
						<?php the_content(); // Contenu principal de la page ?>	
							...
							<img src="<?php echo get_template_directory_uri(); ?>/site_ressources/images/image_05.jpg" class="card-img-top">
                    	</div>
                        <div class="card-footer"><p id="p-rouge"><?php the_field('card_footer_text'); ?></p></div>
                    </div>
                </div>
            </div>
		</div>
