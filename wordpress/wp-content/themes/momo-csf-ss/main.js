...
fetch("./wp-json/wp/v2/news?_embed&order=date&order=asc")
         ...
         for (let i = 0; i < 3; i++) {
           ...
           let link = data[i].link;
            ...
            console.log(link, title, auteur, categorie, date, resume, image);
